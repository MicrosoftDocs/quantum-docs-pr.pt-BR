...
title: _JWOptimized0123TermImpl operação
...
ms.locfileid: "96226036"
---
# <a name="_jwoptimized0123termimpl-operation"></a>_JWOptimized0123TermImpl operação
...
Etapa de implementação de `JWOptimized0123Term_` ;
