...
title: Função MultiplexZCoefficients
...
ms.locfileid: "96206010"
---
# <a name="multiplexzcoefficients-function"></a>Função MultiplexZCoefficients
...
Etapa de implementação de rotações Z com controle de multiplicação.
...
## <a name="output--doubledouble"></a>Saída: ([Double](xref:microsoft.quantum.lang-ref.double)[],[Double](xref:microsoft.quantum.lang-ref.double)[])
