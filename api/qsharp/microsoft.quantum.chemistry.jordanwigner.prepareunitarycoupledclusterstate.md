...
---
# <a name="prepareunitarycoupledclusterstate-operation"></a>Operação PrepareUnitaryCoupledClusterState
...
Preparação de estado de cluster acoplado unitário do estado de avaliação
