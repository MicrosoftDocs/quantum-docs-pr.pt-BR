...
ms.locfileid: "92694895"
---
# <a name="reflectionstart-function"></a>Função ReflectionStart
...
Constrói uma reflexão sobre a cadeia de caracteres All-zero | 0... 0 〉, que é o estado de entrada típico para amplificação de amplitude.
...
Um `ReflectionOracle` que reflete sobre o estado $ \ket{0\cdots 0} $.
