...
---
# <a name="_twoleveldecomposition-function"></a>Função _TwoLevelDecomposition
...
## <a name="output--complexintint"></a>Saída: ([Complex](xref:Microsoft.Quantum.Math.Complex)[] [],[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)) []
