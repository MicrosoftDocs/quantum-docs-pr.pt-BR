...
### <a name="op--phaselittleendian--unit"></a>op: [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [unidade](xref:microsoft.quantum.lang-ref.unit) PhaseLittleEndian 
