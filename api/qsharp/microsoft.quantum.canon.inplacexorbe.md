...
ms.locfileid: "98840415"
---
# <a name="inplacexorbe-operation"></a>Operação InPlaceXorBE
...
> [!WARNING]
> InPlaceXorBE foi preterido. Use <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> em seu lugar.
>
> Esta operação foi removida.
