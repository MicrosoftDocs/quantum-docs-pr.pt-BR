...
ms.locfileid: "92693769"
---
# <a name="_jordanwigneroptimizedquantumwalkbyqubitization_-function"></a>Função _JordanWignerOptimizedQuantumWalkByQubitization_
...
## <a name="output--intintdoublequbitqubit--unit-adj--ctl"></a>Saída: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [unidade](xref:microsoft.quantum.lang-ref.unit) de ano + CTL))
