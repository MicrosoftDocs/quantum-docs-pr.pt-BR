...
ms.locfileid: "98839691"
---
# <a name="headmeasurement-function"></a>Função HeadMeasurement
...
## <a name="output--qubit--__invalidresult__"></a>Saída: [qubit](xref:microsoft.quantum.lang-ref.qubit)[] => __inválido <Result>__ 
