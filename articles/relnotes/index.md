...
- Novo suporte para modificadores de acesso em Q#. Para obter mais informações, confira [Estruturas de arquivo](xref:microsoft.quantum.language.file-structure#internal-declarations)
