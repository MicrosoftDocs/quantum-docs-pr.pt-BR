...
<span data-ttu-id="6c464-104">Como o nome indica, a `ResourcesEstimator` classe estima os recursos necessários para executar uma determinada instância de uma Q# operação em um computador Quantum.</span><span class="sxs-lookup"><span data-stu-id="6c464-104">As the name implies, the `ResourcesEstimator` class estimates the resources required to run a given instance of a Q# operation on a quantum computer.</span></span> <span data-ttu-id="6c464-105">Ele realiza isso executando a operação Quantum sem realmente simular o estado de um computador Quantum; por esse motivo, ele estima recursos para Q# operações que usam milhares de qubits, desde que a parte clássica do código seja executada em um tempo razoável.</span><span class="sxs-lookup"><span data-stu-id="6c464-105">It accomplishes this by running the quantum operation without actually simulating the state of a quantum computer; for this reason, it estimates resources for Q# operations that use thousands of qubits, provided that the classical part of the code runs in a reasonable time.</span></span>
...
<span data-ttu-id="6c464-108">Você pode usar o estimador de recursos para executar qualquer Q# operação.</span><span class="sxs-lookup"><span data-stu-id="6c464-108">You can use the resources estimator to run any Q# operation.</span></span> <span data-ttu-id="6c464-109">Para obter detalhes adicionais, consulte [maneiras de executar um Q# programa](xref:microsoft.quantum.guide.host-programs).</span><span class="sxs-lookup"><span data-stu-id="6c464-109">For additional details, see [Ways to run a Q# program](xref:microsoft.quantum.guide.host-programs).</span></span>
...
<span data-ttu-id="6c464-120">Use o método [estimate_resources ()](https://docs.microsoft.com/python/qsharp-core/qsharp.loader.qsharpcallable) da biblioteca do Python com a operação importada Q# :</span><span class="sxs-lookup"><span data-stu-id="6c464-120">Use the [estimate_resources()](https://docs.microsoft.com/python/qsharp-core/qsharp.loader.qsharpcallable) method from the Python library with the imported Q# operation:</span></span>
...
<span data-ttu-id="6c464-122">Ao executar um Q# programa a partir da linha de comando, use o parâmetro **--Simulator** (ou **-s** Shortcut) para especificar o `ResourcesEstimator` computador de destino.</span><span class="sxs-lookup"><span data-stu-id="6c464-122">When running a Q# program from the command line, use the **--simulator** (or **-s** shortcut) parameter to specify the `ResourcesEstimator` target machine.</span></span> <span data-ttu-id="6c464-123">O comando a seguir executa um programa usando o estimador de recursos:</span><span class="sxs-lookup"><span data-stu-id="6c464-123">The following command runs a program using the resources estimator:</span></span> 
...
<span data-ttu-id="6c464-129">O código a seguir mostra como recuperar e imprimir o número total de `QubitClifford` `T` e `CNOT` as operações usadas por uma Q# operação:</span><span class="sxs-lookup"><span data-stu-id="6c464-129">The following code shows how to retrieve and print the total number of `QubitClifford`, `T` and `CNOT` operations used by a Q# operation:</span></span>
...
|<span data-ttu-id="6c464-144">__Profundidade__</span><span class="sxs-lookup"><span data-stu-id="6c464-144">__Depth__</span></span>|<span data-ttu-id="6c464-145">Profundidade do circuito Quantum executado pela Q# operação (veja [abaixo](#depth-width-and-qubitcount)).</span><span class="sxs-lookup"><span data-stu-id="6c464-145">Depth of the quantum circuit run by the Q# operation (see [below](#depth-width-and-qubitcount)).</span></span> <span data-ttu-id="6c464-146">Por padrão, a métrica de profundidade conta apenas `T` Gates.</span><span class="sxs-lookup"><span data-stu-id="6c464-146">By default, the depth metric only counts `T` gates.</span></span> <span data-ttu-id="6c464-147">Para obter mais detalhes, consulte o [contador de profundidade](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span><span class="sxs-lookup"><span data-stu-id="6c464-147">For more details, see [Depth Counter](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span></span>   |
|<span data-ttu-id="6c464-148">__Largura__</span><span class="sxs-lookup"><span data-stu-id="6c464-148">__Width__</span></span>|<span data-ttu-id="6c464-149">Largura do circuito Quantum executada pela Q# operação (veja [abaixo](#depth-width-and-qubitcount)).</span><span class="sxs-lookup"><span data-stu-id="6c464-149">Width of the quantum circuit run by the Q# operation (see [below](#depth-width-and-qubitcount)).</span></span> <span data-ttu-id="6c464-150">Por padrão, a métrica de profundidade conta apenas `T` Gates.</span><span class="sxs-lookup"><span data-stu-id="6c464-150">By default, the depth metric only counts `T` gates.</span></span> <span data-ttu-id="6c464-151">Para obter mais detalhes, consulte o [contador de profundidade](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span><span class="sxs-lookup"><span data-stu-id="6c464-151">For more details, see [Depth Counter](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span></span>   |
|<span data-ttu-id="6c464-152">__QubitCount__</span><span class="sxs-lookup"><span data-stu-id="6c464-152">__QubitCount__</span></span>    |<span data-ttu-id="6c464-153">O limite inferior para o número máximo de qubits alocadas durante a execução da Q# operação.</span><span class="sxs-lookup"><span data-stu-id="6c464-153">The lower bound for the maximum number of qubits allocated during the run of the Q# operation.</span></span> <span data-ttu-id="6c464-154">Essa métrica pode não ser compatível com __profundidade__ (veja abaixo).</span><span class="sxs-lookup"><span data-stu-id="6c464-154">This metric might not be compatible with __Depth__ (see below).</span></span>  |
|<span data-ttu-id="6c464-155">__BorrowedWidth__</span><span class="sxs-lookup"><span data-stu-id="6c464-155">__BorrowedWidth__</span></span>    |<span data-ttu-id="6c464-156">O número máximo de qubits emprestados dentro da Q# operação.</span><span class="sxs-lookup"><span data-stu-id="6c464-156">The maximum number of qubits borrowed inside the Q# operation.</span></span>  |
