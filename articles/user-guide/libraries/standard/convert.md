...
<span data-ttu-id="d7ebd-104">Q# é uma linguagem **fortemente tipada** .</span><span class="sxs-lookup"><span data-stu-id="d7ebd-104">Q# is a **strongly-typed** language.</span></span>
<span data-ttu-id="d7ebd-105">Em particular, não Q# é implicitamente convertido entre tipos distintos.</span><span class="sxs-lookup"><span data-stu-id="d7ebd-105">In particular, Q# does not implicitly cast between distinct types.</span></span> <span data-ttu-id="d7ebd-106">Por exemplo, `1 + 2.0` não é uma Q# expressão válida.</span><span class="sxs-lookup"><span data-stu-id="d7ebd-106">For instance, `1 + 2.0` is not a valid Q# expression.</span></span>
<span data-ttu-id="d7ebd-107">Em vez disso, Q# o fornece uma variedade de funções de conversão de tipo para construir novos valores de um determinado tipo.</span><span class="sxs-lookup"><span data-stu-id="d7ebd-107">Rather, Q# provides a variety of type conversion functions for constructing new values of a given type.</span></span>
...
<span data-ttu-id="d7ebd-112">Por fim, a Q# biblioteca padrão fornece vários tipos definidos pelo usuário, como <xref:Microsoft.Quantum.Math.Complex> e <xref:Microsoft.Quantum.Arithmetic.LittleEndian> .</span><span class="sxs-lookup"><span data-stu-id="d7ebd-112">Finally, the Q# standard library provides a number of user-defined types such as <xref:Microsoft.Quantum.Math.Complex> and <xref:Microsoft.Quantum.Arithmetic.LittleEndian>.</span></span>
