...
A codificação e o processamento de informações da Quantum são uma alternativa poderosa para os classificadores de Quantum do aprendizado de máquina clássico, em particular, codificar dados em registros Quantum que são concisos em relação ao número de recursos, emprega sistematicamente o Quantum Entanglement como recurso computacional e empregar a medição Quantum para a inferência de classes.
