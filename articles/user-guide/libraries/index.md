...
Nesta seção da documentação, descrevemos essas bibliotecas e como usá-las em seus programas.

- [**Bibliotecas padrão**](xref:microsoft.quantum.libraries.standard.intro): esta seção descreve o prelúdio, que define a interface entre programas em Q# e os computadores de destino, e o cânone, uma biblioteca de Q# que fornece operações e funções de uso geral para escrever programas em Q#.
