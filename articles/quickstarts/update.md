...
### <a name="update-the-iq-jupyter-kernel"></a>Atualizar o kernel de Jupyter do IQ#
...
Agora, você pode usar o kernel do IQ# atualizado para executar seus Jupyter Notebooks do Q# existentes.
