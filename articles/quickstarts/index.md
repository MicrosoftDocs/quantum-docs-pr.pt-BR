...
Os fluxos de trabalho de cada uma dessas configurações são descritos e comparados em [Maneiras de executar um programa em Q#](xref:microsoft.quantum.guide.host-programs).

Para prosseguir com a instalação do QDK e com a criação de projetos em Q#, selecione a configuração de sua preferência:
