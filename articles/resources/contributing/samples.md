...
Examinando os arquivos que compõem cada pasta, vamos nos aprofundar no [`algorithms/chsh-game/`](https://github.com/microsoft/Quantum/tree/main/samples/algorithms/chsh-game) exemplo.
