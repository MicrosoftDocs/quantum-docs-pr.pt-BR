...
Embora esse seja um exemplo trivial (como a < operação xref: Microsoft. Quantum. intrínseca. h > é autoadjacente), você pode ver como isso se torna inestimável para operações de qubit mais complicadas.
